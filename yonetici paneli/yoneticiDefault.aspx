...
&nbsp; Şifre :<asp:TextBox ID="TexYKS" runat="server" Height="24px" Width="168px" TextMode="Password"></asp:TextBox>
        ...
        <div style="color:white;float:left;width:167px; height: 59px; margin-top:0px; font-family:Verdana;font-size:15px;"> 
            <br />
&nbsp; <asp:Button ID="BtnYKG" runat="server" Height="24px" Text="GİRİŞ" Width="71px" ForeColor="#2a595c" BackColor="White" OnClick="BtnYKG_Click" />
        </div> 
    <div style="color:white;float:right;width:167px;margin-right:5px;   text-align :left; font-family:Verdana;font-size:15px;" >     
        <br />
